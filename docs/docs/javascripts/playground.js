...
(function () {
  ...
  function setupEditor(host) {
    ...
    monaco.editor.defineTheme("grok-dark", {
      ...
      inherit: true,
      rules: [
        { token: "type", foreground: "FF7A3D" },
        { token: "string", foreground: "FFD4A8" },
        { token: "number", foreground: "FFD4A8" },
      ...
      colors: {
        ...
        "editorLineNumber.activeForeground": "#FF7A3D",
        "editor.selectionBackground": "#C73E1D33",
