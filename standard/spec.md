...
# Community Self-Management (Wave 4 – new)
community:
  onboard: true                    # enables self-onboarding guide + automatic welcome
  voting_enabled: true             # allows builders & users to vote on featured agents
  moderation_level: "standard"     # "standard" | "light" | "strict" – builder chooses
...
Controlled Adoption Push (Wave 2)
Smart, targeted outreach to high-quality builders only
Automatic welcome + verification flow for every new repo
Builder onboarding guide auto-generated by Grok
High-quality growth without manual promotion
